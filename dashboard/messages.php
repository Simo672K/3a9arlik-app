    ...
    <section class="main">
      ...
      <div class="container-fluid">
        <div class="mb-4 pt-5 px-4 mt-3 rounded" style="background-color: #ffecd1; border-bottom: solid 5px #dec7a5;">
          <h2 class="poppins">📫Votre Inbox.</h2>
          <p class="text-muted">Tous les messages que vous avez recu</p>
        </div>
        ...
        <div class="card shadow-sm border-0 p-4">
          <div class="card-body">
            <div class="border-bottom mb-4">
              <h4 class="mb-3"><i class="fa-solid fa-list-ul"></i> Tous les message (<?php echo $count ?>)</h4>
            </div>
            <div class="mb-4 mt-4">
              <h5 class="mb-2"><i class="fa-solid fa-search me-1"></i> Rechercher un message:</h5>
              <form action="">
                <div class="d-flex">
